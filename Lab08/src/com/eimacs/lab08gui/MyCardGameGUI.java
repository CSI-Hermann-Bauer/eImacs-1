...
public class MyCardGameGUI extends JFrame implements ActionListener
{
    ...
    public MyCardGameGUI(Board gameBoard)
    {
        ...
        cardCoords = new Point[board.getBoardSize()];
        int x = LAYOUT_LEFT;
        int y = LAYOUT_TOP;
        ...
        selections = new boolean[board.getBoardSize()];
        initDisplay();
    ...
    public void repaint()
    {
        for (int k = 0; k < board.getBoardSize(); k++)
        {
            String cardImageFileName
                    = imageFileName(board.getCardAt(k), selections[k]);
        ...
        statusMsg.setText(board.getNumUndealt()
    ...
    private void initDisplay()
    {
        ...
        int numCardRows = (board.getBoardSize() + 4) / 5;
        ...
        displayCards = new JLabel[board.getBoardSize()];
        for (int k = 0; k < board.getBoardSize(); k++)
        {
        ...
        lossMsg.setFont(new Font("SanSerif", Font.BOLD, 22));
